...
```ts
  ...
  26 |    
  27 |     test.setTimeout(10000)
  28 | await page.goto("https://demoqa.com/webtables")
  29 | const rows = page.locator('.rt-tbody .rt-tr-group');
> 30 | await expect(rows.nth(1)).toContainText('Alden');
     |                           ^ Error: expect(locator).toContainText(expected) failed
  31 | })
  32 | 
  33 | 
