...
- Name: up.spec.ts >> Upload file
- Location: tests\up.spec.ts:3:5

# Error details

```
Error: ENOENT: no such file or directory, stat 'C:\Users\2823838\Playwright b1\test-data\sample.pdf'
```
...
```ts
  ...
  5  | 
> 6  |   await page.setInputFiles('#uploadFile','test-data/sample.pdf');
     |   ^ Error: ENOENT: no such file or directory, stat 'C:\Users\2823838\Playwright b1\test-data\sample.pdf'
  7  | 
